...
GRUB_CMDLINE_LINUX_DEFAULT="$GRUB_CMDLINE_LINUX_DEFAULT pti=off nospectre_v1 nospectre_v2 l1tf=off nospec_store_bypass_disable"
...
deb mirror://mirrors.ubuntu.com/mirrors.txt ${LTS_RELEASE} main restricted universe multiverse
deb mirror://mirrors.ubuntu.com/mirrors.txt ${LTS_RELEASE}-security main restricted universe multiverse
deb mirror://mirrors.ubuntu.com/mirrors.txt ${LTS_RELEASE}-updates main restricted universe multiverse
deb mirror://mirrors.ubuntu.com/mirrors.txt ${LTS_RELEASE}-backports main restricted universe multiverse
deb mirror://mirrors.ubuntu.com/mirrors.txt ${LTS_RELEASE}-proposed main restricted universe multiverse
deb http://archive.canonical.com/ubuntu ${LTS_RELEASE} partner
EOF
